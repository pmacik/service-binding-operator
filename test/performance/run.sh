...
yes | go run setup/main.go \
    --template=$WS/user-workloads/valid/sbo-test.with-sbr-01.user-workloads.yaml \
    --template=$WS/user-workloads/valid/sbo-test.with-sbr-02.user-workloads.yaml \
    --template=$WS/user-workloads/valid/sbo-test.with-sbr-03.user-workloads.yaml \
    --template=$WS/user-workloads/valid/sbo-test.with-sbr-04.user-workloads.yaml \
    --users $USERS_PER_SCENARIO --default $DEFAULT_WORKLOADS --custom $USERS_PER_SCENARIO --operators-limit 0 --username $USER_NS_PREFIX-sb-val > $OUTPUT_DIR/$USER_NS_PREFIX-sb-val.log
